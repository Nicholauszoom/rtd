...
public class MainActivity extends AppCompatActivity {
    ...
    private int[] imageUrls = { R.drawable.picf2,  R.drawable.picf6};
...
//        getSupportActionBar().setTitle("Rtd");
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        int numberOfColumns = 2; // Two cards per row
...
//            // Add intent to navigate to SettingsActivity or perform action
//            return true;
//        }
